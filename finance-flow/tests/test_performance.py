...
class TestPerformance:
    def test_dashboard_loads_under_3s_with_500_transactions(self, db_session, large_transaction_set):
    ...
    def test_chart_data_fast_with_500_transactions(self, db_session, large_transaction_set):
        for t in large_transaction_set:
            add_transaction(**t)
